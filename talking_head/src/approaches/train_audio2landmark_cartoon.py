...
#        print('Run on device:', device)
        ...
        self.eval_data = Audio2landmark_Dataset(dump_dir='examples_cartoon/dump',
                                                dump_name='random',
                                                status='val',
    ...
    def __train_pass__(self, au_emb=None, centerize_face=False, no_y_rotation=False, vis_fls=False):
        ...
        for i, batch in enumerate(dataloader):
            ...
            for key in keys: # ['45hn7-LXDX8']: #['sxCbrYjBsGA']:#
                ...
                print('landmark_cartoon', os.path.join(self.opt_parser.output_folder, filename))
                
                # ''' Visualize result in landmarks '''
                if(vis_fls):
                    print('landmark_cartoon visualize.')
